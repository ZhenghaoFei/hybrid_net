...
class QNetwork(object):
    ...
    def create_Q_network(self):
        ...
        fc1 = tflearn.fully_connected(features_rnn, 64, activation='relu')
        for i in range(self.layers - 1):
            fc2 = tflearn.fully_connected(fc1, 32, activation='relu')
            fc1 = tflearn.fully_connected(fc2, 64, activation='relu')
