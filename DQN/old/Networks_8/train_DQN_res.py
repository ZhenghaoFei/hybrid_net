...
class QNetwork(object):
    ...
    def create_Q_network(self):
        ...
        net = tflearn.fully_connected(features_res, 64, activation='relu', name='net')
        for i in range(self.layers - 1):
            fc1 = tflearn.fully_connected(net, 32, activation='relu', name='fc1')
            fc2 = tflearn.fully_connected(fc1, 32, name='fc2')
            fc_res = tflearn.fully_connected(features_res, 32, name='fc_res')
