...
class QNetwork(object):
    ...
    def create_Q_network(self):
        ...
        fc1 = tflearn.fully_connected(features_rnn, 256)
        fc2 = tflearn.fully_connected(fc1, 128)
        fc_fb = tflearn.fully_connected(fc2, 256)
        ...
        # plain
        net_plain = tflearn.fully_connected(features, 256, activation='relu')
        net_plain = tflearn.fully_connected(net_plain, 128, activation='relu')
