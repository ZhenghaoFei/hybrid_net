...
class QNetwork(object):
    ...
    def create_Q_network(self):
        ...
        net = tflearn.fully_connected(features_res, 16, activation='relu', name='net')
        for i in range(self.layers - 1):
            fc1 = tflearn.fully_connected(net, 8, activation='relu', name='fc1')
            fc2 = tflearn.fully_connected(fc1, 16, name='fc2')
            fc_res = tflearn.fully_connected(features_res, 16, name='fc_res')
